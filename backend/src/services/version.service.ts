...
export class VersionService {
  static async uploadNewVersion(fileId: number, userId: number, file: Express.Multer.File) {
  ...
  static async getVersionHistory(fileId: number, userId: number) {
    ...
    if (!isOwner) {
      ...
      if (!share) throw new Error('File not found');
    }
  ...
  static async restoreVersion(fileId: number, versionId: number, userId: number) {
  ...
  static async deleteVersion(versionId: number, userId: number) {
    ...
    if (version.file.userId !== userId) throw new Error('Version not found');
